 ...
 */
package com.cn.flume.tail.util;
...
import com.cn.flume.tail.source.TailSource;
...
public class Cursor {
  ...
  // For buffering reads
  final ByteBuffer buf = ByteBuffer.allocateDirect(1048576);
  ...
  public Cursor(BlockingQueue<Event> sync, File f) {
    this(sync, f, 0, 0, 0);
  }

  public Cursor(BlockingQueue<Event> sync, File f, long lastReadOffset, long lastFileLen, long lastMod) {
    this.sync = sync;
    this.file = f;
